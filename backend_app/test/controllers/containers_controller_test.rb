...
class ContainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post containers_url, params: { container: { container_name: @container.container_name, name: @container.name, image: @container.image } }
    end
  ...
  test "should update container" do
    patch container_url(@container), params: { container: { container_name: @container.container_name, name: @container.name, image: @container.image } }
